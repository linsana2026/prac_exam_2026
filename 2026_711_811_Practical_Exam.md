...
4. List all the hidden files in this repo. Paste the command below (2 points) -1 point
...
7. How large (file size) are the two uncompressed fastq files? Use a single command with appropriate options to show the file sizes in a human-readable format (e.g., MB). Paste the command and output below. (2 points) -1 point
